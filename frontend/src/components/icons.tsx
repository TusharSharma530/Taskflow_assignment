...
export function TaskFlowLogo(props: IconProps) {
  return (
    <svg width={22} height={22} viewBox="0 0 24 24" fill="none" aria-hidden {...props}>
      ...
      <rect x="14" y="4" width="7" height="10" rx="2" fill="currentColor" opacity="0.55" />
      <rect x="14" y="17" width="7" height="3" rx="1.5" fill="currentColor" opacity="0.35" />
    </svg>
  );
}
